...
against the 1.2.0.0 build in `dist/`.
...
**Status: fixed in 1.2.0.0, not yet uploaded.** `src/visual.ts:135-153` takes
...
> Version of the visual contained in the .pbix sample file is 1.2.0.0
...
**Status: fixed.** `store/pill-toggle-slicer-sample.pbix` now embeds 1.2.0.0, with JS, CSS and
capabilities byte-identical to
`dist/pillToggleSlicer17CF177366264F91B44C2C53979DB313.1.2.0.0.pbiviz`.
...
prediction was not raised, having been fixed in 1.2.0.0 before the review completed.
...
| Sample .pbix embeds the submitted visual version (1180.2.3) | **Fixed** - sample embeds 1.2.0.0, byte-identical to `dist/pillToggleSlicer17CF177366264F91B44C2C53979DB313.1.2.0.0.pbiviz` |
...
embeds 1.2.0.0, matching the package in `dist/`. Upload both slots together - uploading one
