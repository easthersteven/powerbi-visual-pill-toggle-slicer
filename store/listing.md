...
Source: https://github.com/easthersteven/powerbi-visual-pill-toggle-slicer (branch: certification). Public repository, no credentials required. Build and test instructions in README.
